...
def _content_depth_opportunity(pages: list[dict], metrics: dict | None) -> dict[str, Any] | None:
    ...
    return {
        ...
        "pages": candidates,
        "lever": "High-intent URLs carry thin copy and weak internal support relative to the job they are meant to win.",
        "mechanism": "Depth plus contextual internal links reinforce which page should own the buyer decision.",
        "opportunity": "These pages are ranking targets but lack depth",
        "impact": "Stronger pages convert better and capture more of the demand you already attract",
...
def _internal_linking_opportunity(pages: list[dict]) -> dict[str, Any] | None:
    ...
    return {
        ...
        "pages": candidates,
        "lever": "Important destinations exist but the rest of the site rarely points contextually to them.",
        "mechanism": "Inbound internal links route attention and reinforce which URLs are primary for each job.",
        "opportunity": "These pages are not being reinforced by the site structure",
        "impact": "Better internal support improves discoverability and keeps authority on the URLs that matter",
